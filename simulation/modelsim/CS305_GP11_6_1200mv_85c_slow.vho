...
-- Equation(s):
-- \inst1|blue_out~0_combout\ = (\inst1|video_on_v~q\ & \inst1|video_on_h~q\)
...
-- Equation(s):
-- \mouse1|LessThan5~1_combout\ = (\mouse1|new_cursor_row\(8) & (\mouse1|new_cursor_row\(6) & (\mouse1|new_cursor_row\(7) & \mouse1|new_cursor_row\(5))))
...
PORT MAP (
	...
	datab => \mouse1|LessThan5~0_combout\,
	datac => \mouse1|LessThan5~1_combout\,
...
-- Equation(s):
-- \mouse1|MOUSE_CLK_FILTER~1_combout\ = (\mouse1|filter\(5) & ((\mouse1|MOUSE_CLK_FILTER~q\) # ((\mouse1|filter\(3) & \mouse1|filter\(2))))) # (!\mouse1|filter\(5) & (\mouse1|MOUSE_CLK_FILTER~q\ & ((\mouse1|filter\(3)) # (\mouse1|filter\(2)))))
...
-- pragma translate_on
PORT MAP (
	datab => \mouse1|new_cursor_column\(1),
	datad => \mouse1|cursor_column[0]~6_combout\,
...
-- Equation(s):
-- \mouse1|cursor_row~5_combout\ = ((\mouse1|cursor_row~0_combout\ & (\mouse1|new_cursor_row\(4) & !\mouse1|RECV_UART~5_combout\))) # (!\mouse1|Equal3~0_combout\)
...
-- Equation(s):
-- \mouse1|cursor_row~9_combout\ = (\mouse1|cursor_row~0_combout\ & (\mouse1|new_cursor_row\(0) & (\mouse1|Equal3~0_combout\ & !\mouse1|RECV_UART~5_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \mouse1|mouse_state.INPUT_PACKETS~q\,
...
-- Equation(s):
-- \mouse1|WideOr4~combout\ = (\mouse1|mouse_state.LOAD_COMMAND2~q\) # ((\mouse1|mouse_state.LOAD_COMMAND~q\) # (!\mouse1|mouse_state.INHIBIT_TRANS~q\))
...
-- Equation(s):
-- \inst1|Equal0~1_combout\ = (!\inst1|h_count\(5) & (!\inst1|h_count\(7) & (\inst1|h_count\(2) & \inst1|h_count\(8))))
...
-- Equation(s):
-- \inst1|Equal0~2_combout\ = (\inst1|h_count\(9) & (!\inst1|h_count\(6) & (\inst1|Equal0~1_combout\ & \inst1|Equal0~0_combout\)))
...
-- Equation(s):
-- \inst1|v_count[8]~6_combout\ = (\inst1|Add1~16_combout\ & ((\inst1|v_count[4]~0_combout\) # ((!\inst1|v_count[0]~1_combout\ & \inst1|v_count\(8))))) # (!\inst1|Add1~16_combout\ & (!\inst1|v_count[0]~1_combout\ & (\inst1|v_count\(8))))
...
-- Equation(s):
-- \inst1|v_count[5]~3_combout\ = (\inst1|Add1~10_combout\ & ((\inst1|v_count[4]~0_combout\) # ((\inst1|v_count\(5) & !\inst1|v_count[0]~1_combout\)))) # (!\inst1|Add1~10_combout\ & (((\inst1|v_count\(5) & !\inst1|v_count[0]~1_combout\))))
...
-- Equation(s):
-- \inst1|v_count~8_combout\ = (\inst1|Add1~2_combout\ & ((\inst1|process_0~11_combout\) # ((\inst1|process_0~8_combout\) # (\inst1|process_0~12_combout\))))
...
-- Equation(s):
-- \inst1|v_count[9]~2_combout\ = (\inst1|v_count[0]~1_combout\ & (\inst1|v_count[4]~0_combout\ & ((\inst1|Add1~18_combout\)))) # (!\inst1|v_count[0]~1_combout\ & ((\inst1|v_count\(9)) # ((\inst1|v_count[4]~0_combout\ & \inst1|Add1~18_combout\))))
...
-- Equation(s):
-- \inst1|v_count[0]~1_combout\ = ((!\inst1|process_0~11_combout\ & (!\inst1|process_0~8_combout\ & !\inst1|process_0~12_combout\))) # (!\inst1|Equal1~1_combout\)
...
-- Equation(s):
-- \inst1|v_count[4]~11_combout\ = (\inst1|Add1~8_combout\ & ((\inst1|v_count[4]~0_combout\) # ((\inst1|v_count\(4) & !\inst1|v_count[0]~1_combout\)))) # (!\inst1|Add1~8_combout\ & (((\inst1|v_count\(4) & !\inst1|v_count[0]~1_combout\))))
...
-- Equation(s):
-- \inst1|v_count[3]~10_combout\ = (\inst1|v_count[0]~1_combout\ & (\inst1|v_count[4]~0_combout\ & ((\inst1|Add1~6_combout\)))) # (!\inst1|v_count[0]~1_combout\ & ((\inst1|v_count\(3)) # ((\inst1|v_count[4]~0_combout\ & \inst1|Add1~6_combout\))))
...
-- Equation(s):
-- \inst1|v_count[7]~5_combout\ = (\inst1|v_count[0]~1_combout\ & (\inst1|Add1~14_combout\ & ((\inst1|v_count[4]~0_combout\)))) # (!\inst1|v_count[0]~1_combout\ & ((\inst1|v_count\(7)) # ((\inst1|Add1~14_combout\ & \inst1|v_count[4]~0_combout\))))
...
-- Equation(s):
-- \inst1|process_0~8_combout\ = (!\inst1|v_count\(6) & (\inst1|process_0~7_combout\ & (!\inst1|v_count\(8) & !\inst1|v_count\(7))))
...
-- Equation(s):
-- \inst1|v_count[4]~0_combout\ = (!\inst1|Equal1~1_combout\ & ((\inst1|process_0~11_combout\) # ((\inst1|process_0~8_combout\) # (\inst1|process_0~12_combout\))))
...
-- Equation(s):
-- \inst1|v_count[2]~9_combout\ = (\inst1|v_count[0]~1_combout\ & (\inst1|v_count[4]~0_combout\ & ((\inst1|Add1~4_combout\)))) # (!\inst1|v_count[0]~1_combout\ & ((\inst1|v_count\(2)) # ((\inst1|v_count[4]~0_combout\ & \inst1|Add1~4_combout\))))
...
-- Equation(s):
-- \inst1|v_count[6]~4_combout\ = (\inst1|v_count[0]~1_combout\ & (\inst1|Add1~12_combout\ & ((\inst1|v_count[4]~0_combout\)))) # (!\inst1|v_count[0]~1_combout\ & ((\inst1|v_count\(6)) # ((\inst1|Add1~12_combout\ & \inst1|v_count[4]~0_combout\))))
...
-- Equation(s):
-- \inst4|char_data|Mux0~0_combout\ = (\inst1|pixel_column\(2) & (((\inst1|pixel_column\(3))))) # (!\inst1|pixel_column\(2) & ((\inst1|pixel_column\(3) & (\inst4|char_data|altsyncram_component|auto_generated|q_a\(1))) # (!\inst1|pixel_column\(3) & 
-- ((\inst4|char_data|altsyncram_component|auto_generated|q_a\(3))))))
...
PORT MAP (
	...
	datad => \inst4|char_data|altsyncram_component|auto_generated|q_a\(3),
	combout => \inst4|char_data|Mux0~0_combout\);

-- Location: LCCOMB_X14_Y14_N20
\inst4|char_data|Mux0~1\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst4|char_data|Mux0~1_combout\ = (\inst1|pixel_column\(2) & ((\inst4|char_data|Mux0~0_combout\ & ((\inst4|char_data|altsyncram_component|auto_generated|q_a\(0)))) # (!\inst4|char_data|Mux0~0_combout\ & 
-- (\inst4|char_data|altsyncram_component|auto_generated|q_a\(2))))) # (!\inst1|pixel_column\(2) & (((\inst4|char_data|Mux0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|char_data|altsyncram_component|auto_generated|q_a\(2),
	datab => \inst1|pixel_column\(2),
	datac => \inst4|char_data|altsyncram_component|auto_generated|q_a\(0),
	datad => \inst4|char_data|Mux0~0_combout\,
...
-- Equation(s):
-- \inst4|char_data|Mux0~2_combout\ = (\inst1|pixel_column\(2) & (((\inst4|char_data|altsyncram_component|auto_generated|q_a\(6)) # (\inst1|pixel_column\(3))))) # (!\inst1|pixel_column\(2) & (\inst4|char_data|altsyncram_component|auto_generated|q_a\(7) & 
-- ((!\inst1|pixel_column\(3)))))
...
PORT MAP (
	...
	datab => \inst4|char_data|altsyncram_component|auto_generated|q_a\(6),
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|char_data|altsyncram_component|auto_generated|q_a\(5),
	datab => \inst4|char_data|Mux0~2_combout\,
	datac => \inst4|char_data|altsyncram_component|auto_generated|q_a\(4),
	datad => \inst1|pixel_column\(3),
...
PORT MAP (
	...
	datab => \inst4|char_data|Mux0~1_combout\,
	datac => \inst1|pixel_column\(4),
	datad => \inst4|char_data|Mux0~3_combout\,
...
-- Equation(s):
-- \mouse1|LessThan1~0_combout\ = ((!\mouse1|INCNT\(1) & (!\mouse1|INCNT\(0) & !\mouse1|INCNT\(2)))) # (!\mouse1|INCNT\(3))
...
-- Equation(s):
-- \mouse1|SHIFTIN[0]~2_combout\ = (\mouse1|READ_CHAR~q\ & (!\mouse1|mouse_state.WAIT_OUTPUT_READY~q\ & \mouse1|LessThan1~0_combout\))
...
-- Equation(s):
-- \mouse1|PACKET_CHAR2[7]~0_combout\ = (\mouse1|READ_CHAR~q\ & (!\mouse1|LessThan1~0_combout\ & !\mouse1|mouse_state.WAIT_OUTPUT_READY~q\))
...
-- Equation(s):
-- \mouse1|PACKET_CHAR1[0]~1_combout\ = (!\mouse1|mouse_state.WAIT_OUTPUT_READY~q\ & (\mouse1|READ_CHAR~q\ & (!\mouse1|PACKET_CHAR1[0]~0_combout\ & !\mouse1|LessThan1~0_combout\)))
...
-- Equation(s):
-- \mouse1|PACKET_CHAR2[7]~1_combout\ = (\mouse1|PACKET_COUNT\(1) & !\mouse1|PACKET_COUNT\(0))
...
-- Equation(s):
-- \mouse1|new_cursor_column[9]~30_combout\ = (!\mouse1|mouse_state.WAIT_OUTPUT_READY~q\ & (\mouse1|READ_CHAR~q\ & (!\mouse1|Add3~0_combout\ & !\mouse1|LessThan1~0_combout\)))
...
-- Equation(s):
-- \mouse1|cursor_column[9]~7_combout\ = (!\mouse1|PACKET_COUNT\(1) & (!\mouse1|mouse_state.WAIT_OUTPUT_READY~q\ & (\mouse1|READ_CHAR~q\ & !\mouse1|LessThan1~0_combout\)))
...
-- Equation(s):
-- \mouse1|RECV_UART~0_combout\ = (!\mouse1|new_cursor_column\(2) & (!\mouse1|new_cursor_column\(6) & (!\mouse1|new_cursor_column\(3) & !\mouse1|new_cursor_column\(1))))
...
-- Equation(s):
-- \mouse1|RECV_UART~1_combout\ = (!\mouse1|new_cursor_column\(4) & (!\mouse1|new_cursor_column\(5) & \mouse1|RECV_UART~0_combout\))
...
-- Equation(s):
-- \mouse1|cursor_column~8_combout\ = (\mouse1|Equal3~0_combout\ & (!\mouse1|cursor_column[0]~17_combout\ & ((!\mouse1|RECV_UART~7_combout\) # (!\mouse1|RECV_UART~2_combout\))))
...
PORT MAP (
	...
	datac => \mouse1|cursor_column[0]~17_combout\,
...
-- Equation(s):
-- \mouse1|RECV_UART~2_combout\ = (!\mouse1|cursor_column\(7) & (!\mouse1|cursor_column\(9) & !\mouse1|cursor_column\(8)))
...
-- Equation(s):
-- \mouse1|cursor_column[0]~6_combout\ = (\mouse1|Equal3~0_combout\ & (\mouse1|cursor_column[0]~17_combout\ & ((!\mouse1|RECV_UART~7_combout\) # (!\mouse1|RECV_UART~2_combout\))))
...
-- Equation(s):
-- \mouse1|cursor_column~19_combout\ = (\mouse1|PACKET_COUNT\(1) & (((\mouse1|new_cursor_column\(8) & \mouse1|cursor_column[0]~6_combout\)))) # (!\mouse1|PACKET_COUNT\(1) & (((\mouse1|new_cursor_column\(8) & \mouse1|cursor_column[0]~6_combout\)) # 
...
-- Equation(s):
-- \mouse1|cursor_column~18_combout\ = (\mouse1|new_cursor_column\(6) & ((\mouse1|cursor_column[0]~6_combout\) # ((!\mouse1|PACKET_COUNT\(0) & !\mouse1|PACKET_COUNT\(1))))) # (!\mouse1|new_cursor_column\(6) & (!\mouse1|PACKET_COUNT\(0) & 
...
-- Equation(s):
-- \mouseCol7seg|Mux1~0_combout\ = (\mouse1|cursor_column\(8) & (\mouse1|cursor_column\(6) & (\mouse1|cursor_column\(7) $ (\mouse1|cursor_column\(9))))) # (!\mouse1|cursor_column\(8) & (!\mouse1|cursor_column\(9) & ((\mouse1|cursor_column\(6)) # 
...
-- Equation(s):
-- \mouseCol7seg|Mux3~0_combout\ = (\mouse1|cursor_column\(6) & (\mouse1|cursor_column\(8) $ ((!\mouse1|cursor_column\(7))))) # (!\mouse1|cursor_column\(6) & ((\mouse1|cursor_column\(8) & (!\mouse1|cursor_column\(7) & !\mouse1|cursor_column\(9))) # 
-- (!\mouse1|cursor_column\(8) & (\mouse1|cursor_column\(7) & \mouse1|cursor_column\(9)))))
...
-- Equation(s):
-- \mouseCol7seg|Mux4~0_combout\ = (\mouse1|cursor_column\(8) & (\mouse1|cursor_column\(9) & ((\mouse1|cursor_column\(7)) # (!\mouse1|cursor_column\(6))))) # (!\mouse1|cursor_column\(8) & (!\mouse1|cursor_column\(6) & (\mouse1|cursor_column\(7) & 
-- !\mouse1|cursor_column\(9))))
...
-- Equation(s):
-- \mouseCol7seg|Mux6~0_combout\ = (\mouse1|cursor_column\(8) & (!\mouse1|cursor_column\(7) & (\mouse1|cursor_column\(6) $ (!\mouse1|cursor_column\(9))))) # (!\mouse1|cursor_column\(8) & (\mouse1|cursor_column\(6) & (\mouse1|cursor_column\(7) $ 
-- (!\mouse1|cursor_column\(9)))))
...
-- Equation(s):
-- \mouse1|RECV_UART~3_combout\ = (!\mouse1|new_cursor_row\(7) & (!\mouse1|new_cursor_row\(6) & (!\mouse1|new_cursor_row\(5) & \mouse1|LessThan5~0_combout\)))
...
-- Equation(s):
-- \mouse1|RECV_UART~5_combout\ = (!\mouse1|cursor_row\(8) & (!\mouse1|cursor_row\(7) & \mouse1|RECV_UART~4_combout\))
...
-- Equation(s):
-- \mouse1|cursor_row~8_combout\ = (\mouse1|cursor_row~0_combout\ & (\mouse1|new_cursor_row\(1) & (\mouse1|Equal3~0_combout\ & !\mouse1|RECV_UART~5_combout\)))
...
-- Equation(s):
-- \mouse1|cursor_row~7_combout\ = (\mouse1|cursor_row~0_combout\ & (\mouse1|new_cursor_row\(2) & (\mouse1|Equal3~0_combout\ & !\mouse1|RECV_UART~5_combout\)))
...
-- Equation(s):
-- \mouse1|cursor_row~6_combout\ = (\mouse1|cursor_row~0_combout\ & (\mouse1|new_cursor_row\(3) & (\mouse1|Equal3~0_combout\ & !\mouse1|RECV_UART~5_combout\)))
...
-- Equation(s):
-- \mouseRow7seg|Mux0~0_combout\ = (\mouse1|cursor_row\(8) & (\mouse1|cursor_row\(7) & \mouse1|cursor_row\(6))) # (!\mouse1|cursor_row\(8) & (!\mouse1|cursor_row\(7)))
...
-- Equation(s):
-- \mouseRow7seg|Mux5~0_combout\ = (\mouse1|cursor_row\(7) $ (!\mouse1|cursor_row\(6))) # (!\mouse1|cursor_row\(8))
